import { LitElement as l, css as b, html as n } from "lit";
import { n as e } from "../../../property-CemaeiRl.js";
import { o as d } from "../../../if-defined-C8i28hSj.js";
var c = Object.defineProperty, a = (o, t, g, u) => {
  for (var r = void 0, i = o.length - 1, p; i >= 0; i--)
    (p = o[i]) && (r = p(t, g, r) || r);
  return r && c(t, g, r), r;
};
class s extends l {
  constructor() {
    super(...arguments), this.max = 100, this.label = "", this.size = "medium";
  }
  static get styles() {
    return b`
      :host {
