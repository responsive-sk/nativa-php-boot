import { LitElement as d, css as c, html as h } from "lit";
import { n as p } from "../../../property-CemaeiRl.js";
var b = Object.defineProperty, l = (i, s, n, g) => {
  for (var e = void 0, t = i.length - 1, o; t >= 0; t--)
    (o = i[t]) && (e = o(s, n, e) || e);
  return e && b(s, n, e), e;
};
const a = class a extends d {
  constructor() {
    super(), this.size = "default", this.ariaLabel = "Loading...";
  }
  render() {
    return h`
      <div
