import { LitElement as h, css as u, html as i } from "lit";
import { n as e } from "../../../property-CemaeiRl.js";
import { o as g } from "../../../if-defined-C8i28hSj.js";
var p = Object.defineProperty, o = (l, a, n, v) => {
  for (var r = void 0, s = l.length - 1, d; s >= 0; s--)
    (d = l[s]) && (r = d(a, n, r) || r);
  return r && p(a, n, r), r;
};
const c = class c extends h {
  constructor() {
    super(), this._handleClick = (a) => {
      if (this.disabled || this.loading) {
        a.preventDefault(), a.stopPropagation();
        return;
      }
      const n = new CustomEvent("icon-button-click", {
        detail: {
          originalEvent: a,
          label: this.label,
      ...
      this.dispatchEvent(n), this.onIconButtonClick && this.onIconButtonClick(n);
    }, this._handleKeyDown = (a) => {
      if ((a.key === " " || a.key === "Enter") && !this.disabled && !this.loading) {
        const n = new CustomEvent("icon-button-activate", {
          detail: {
            originalEvent: a,
            label: this.label,
            pressed: this.pressed
        ...
        this.dispatchEvent(n), this.onIconButtonActivate && this.onIconButtonActivate(n);
      }
    }, this.label = "", this.icon = "", this.unicode = "", this.size = "md", this.variant = "ghost", this.disabled = !1, this.pressed = !1, this.loading = !1, this.type = "button";
  }
  /**
   * Renders the appropriate icon content
   */
  _renderIcon() {
    return this.children.length > 0 ? i`
  ...
  render() {
    return this.label || console.warn("AgIconButton: label property is required for accessibility. Please provide an aria-label value."), i`
      <button
        part="ag-icon-button"
        type=${this.type}
        aria-label=${g(this.label || void 0)}
        aria-pressed=${g(this.pressed !== void 0 ? this.pressed.toString() : void 0)}
...
o([
  e({ attribute: !1 })
], t.prototype, "onIconButtonClick");
o([
  e({ attribute: !1 })
], t.prototype, "onIconButtonActivate");
export {
  t as AgIconButton
};
