import { LitElement as h, css as p, html as o } from "lit";
import { n as t } from "../../../property-CemaeiRl.js";
var l = Object.defineProperty, r = (v, i, s, d) => {
  for (var e = void 0, n = v.length - 1, c; n >= 0; n--)
    (c = v[n]) && (e = c(i, s, e) || e);
  return e && l(i, s, e), e;
};
const g = class g extends h {
  constructor() {
    super(), this.text = "", this.imgSrc = "", this.imgAlt = "", this.size = "md", this.shape = "circle", this.variant = "default", this.ariaLabel = "";
  }
  _renderContent() {
    return this.imgSrc ? o`<img
        class="avatar-image"
        part="ag-avatar-image"
        src="${this.imgSrc}"
        alt="${this.imgAlt}"
      />` : this.text ? o`<span class="avatar-text" part="ag-avatar-text">${this.text}</span>` : o`<slot></slot>`;
  }
  render() {
    const i = this.imgSrc && !this.imgAlt ? "presentation" : "img", s = this.ariaLabel || (this.imgSrc ? this.imgAlt : this.text);
    return o`
      <div
        class="avatar"
        part="ag-avatar"
...
r([
  t({ type: String, attribute: "img-src" })
], a.prototype, "imgSrc");
r([
  t({ type: String, attribute: "img-alt" })
], a.prototype, "imgAlt");
r([
...
r([
  t({ type: String, reflect: !0, attribute: "aria-label" })
], a.prototype, "ariaLabel");
customElements.get("ag-avatar") || customElements.define("ag-avatar", a);
export {
  a as Avatar
};
