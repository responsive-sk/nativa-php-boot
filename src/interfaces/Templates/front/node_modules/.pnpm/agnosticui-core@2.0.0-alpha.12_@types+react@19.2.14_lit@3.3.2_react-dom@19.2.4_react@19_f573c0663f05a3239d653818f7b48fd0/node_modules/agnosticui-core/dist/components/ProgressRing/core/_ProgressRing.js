import { LitElement as d, css as h, html as m } from "lit";
import { n as i } from "../../../property-CemaeiRl.js";
var f = Object.defineProperty, y = Object.getOwnPropertyDescriptor, s = (u, r, e, o) => {
  for (var a = o > 1 ? void 0 : o ? y(r, e) : r, n = u.length - 1, l; n >= 0; n--)
    (l = u[n]) && (a = (o ? l(r, e, a) : l(a)) || a);
  return o && a && f(r, e, a), a;
};
const c = 100, b = 10, p = (c - b) / 2, g = 2 * Math.PI * p, v = class v extends d {
  constructor() {
    super(...arguments), this._value = 0, this.noAnimation = !1;
  }
  get value() {
    return this._value;
  }
  set value(r) {
    const e = Math.max(0, Math.min(100, Number(r) || 0));
    this._value !== e && (this._value = e, this.requestUpdate());
  }
  render() {
    const r = g - this._value / 100 * g, e = g.toFixed(4);
    return m`
      <div
      ...
      >
        <svg viewBox="0 0 ${c} ${c}">
          <circle part="ag-track" class="track" r="${p}"></circle>
          <circle
            part="ag-indicator"
            class="indicator"
            r="${p}"
...
s([
  i({ type: Boolean, reflect: !0, attribute: "no-animation" })
