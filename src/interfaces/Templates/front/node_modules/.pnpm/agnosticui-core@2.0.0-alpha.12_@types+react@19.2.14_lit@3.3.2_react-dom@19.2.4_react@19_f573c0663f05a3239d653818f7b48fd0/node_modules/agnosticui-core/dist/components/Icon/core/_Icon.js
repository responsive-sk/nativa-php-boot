import { LitElement as h, css as p, html as g } from "lit";
import { n as o } from "../../../property-CemaeiRl.js";
var v = Object.defineProperty, s = (n, r, l, f) => {
  for (var e = void 0, i = n.length - 1, c; i >= 0; i--)
    (c = n[i]) && (e = c(r, l, e) || e);
  return e && v(r, l, e), e;
};
const a = class a extends h {
  constructor() {
    super(), this.size = "16", this.type = "", this.noFill = !1;
  }
  render() {
    return g`
...
s([
  o({ type: Boolean, reflect: !0, attribute: "no-fill" })
], t.prototype, "noFill");
export {
  t as AgIcon
};
