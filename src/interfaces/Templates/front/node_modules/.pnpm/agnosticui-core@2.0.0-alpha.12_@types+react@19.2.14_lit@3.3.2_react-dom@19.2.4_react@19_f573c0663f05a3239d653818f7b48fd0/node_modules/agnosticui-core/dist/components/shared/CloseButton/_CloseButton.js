import { LitElement as p, css as v, html as u } from "lit";
import { n as r } from "../../../property-CemaeiRl.js";
var g = Object.defineProperty, e = (i, t, c, b) => {
...
const n = class n extends p {
  constructor() {
    ...
    }, this.label = "Close", this.size = "md", this.position = void 0, this.variant = "default";
  }
  render() {
    const t = [
      "close-button",
