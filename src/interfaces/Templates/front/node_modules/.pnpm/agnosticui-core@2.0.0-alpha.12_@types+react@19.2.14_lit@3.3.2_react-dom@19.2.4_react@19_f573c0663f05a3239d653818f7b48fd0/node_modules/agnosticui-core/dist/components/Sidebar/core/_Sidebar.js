import { LitElement as g, css as h, html as d } from "lit";
import { n as a } from "../../../property-CemaeiRl.js";
var b = Object.defineProperty, o = (p, e, r, c) => {
...
const l = class l extends g {
  constructor() {
    super(), this._handleBackdropClick = () => {
      this.open = !1, this._dispatchToggleEvent();
    }, this._handleToggleClick = () => {
      this.open = !this.open, this._dispatchToggleEvent();
    }, this._handleHeaderToggleClick = () => {
      this.disableCompactMode ? (this.open = !this.open, this._dispatchToggleEvent()) : (this.collapsed = !this.collapsed, this._dispatchCollapseEvent());
    }, this._handleKeydown = (e) => {
      e.key === "Escape" && this.open && (e.preventDefault(), this.open = !1, this._dispatchToggleEvent());
    }, this.open = !1, this.collapsed = !1, this.position = "left", this.ariaLabel = "Navigation", this.variant = "default", this.noTransition = !1, this.width = void 0, this.disableCompactMode = !1, this.showMobileToggle = !0, this.mobileTogglePosition = "top-left", this.showHeaderToggle = !1;
  }
  /**
   ...
   */
  toggleCollapse() {
    this.collapsed = !this.collapsed, this._dispatchCollapseEvent();
  }
  /**
   ...
   */
  toggleResponsive() {
    this.disableCompactMode ? (this.open = !this.open, this._dispatchToggleEvent()) : this._isMobileViewport() && this.open ? (this.open = !1, this._dispatchToggleEvent()) : (this.collapsed = !this.collapsed, this._dispatchCollapseEvent());
  }
  connectedCallback() {
  ...
  willUpdate(e) {
    e.has("width") && (this.width ? this.style.setProperty("--ag-sidebar-width", this.width) : this.style.removeProperty("--ag-sidebar-width")), e.has("open") && (this.open ? (document.addEventListener("keydown", this._handleKeydown), this.updateComplete.then(() => this._trapFocus())) : (document.removeEventListener("keydown", this._handleKeydown), this._releaseFocus()));
  }
  _dispatchToggleEvent() {
    const e = new CustomEvent("ag-sidebar-toggle", {
      detail: { open: this.open },
      bubbles: !0,
      composed: !0
    });
    this.dispatchEvent(e), this.onToggle?.(e);
  }
  _dispatchCollapseEvent() {
    const e = new CustomEvent("ag-sidebar-collapse", {
      detail: { collapsed: this.collapsed },
      bubbles: !0,
      composed: !0
    });
    this.dispatchEvent(e), this.onCollapse?.(e);
  }
  _findMainContent() {
    return this.closest("main") || this.parentElement?.querySelector("main") || document.querySelector("main") || document.body;
  }
  _trapFocus() {
    const e = this._findMainContent();
    e && e !== this && !e.contains(this) && (e.setAttribute("inert", ""), this._mainContentRef = e), this.updateComplete.then(() => {
      this.shadowRoot?.querySelector('button:not([disabled]), a[href], input:not([disabled]), [tabindex]:not([tabindex="-1"])')?.focus();
    });
  }
  _releaseFocus() {
    this._mainContentRef && (this._mainContentRef.removeAttribute("inert"), this._mainContentRef = void 0);
  }
  _handleSlotClick(e) {
    const i = e.composedPath()[0].closest("[aria-expanded]");
    if (i) {
      const n = i.getAttribute("aria-expanded") === "true";
      i.setAttribute("aria-expanded", String(!n));
      const s = i.nextElementSibling;
      s && s.tagName === "AG-SIDEBAR-NAV-SUBMENU" && (n ? s.removeAttribute("open") : s.setAttribute("open", ""));
    }
  }
  _renderToggleIcon() {
    return d`
...
o([
  a({ type: Boolean, attribute: "no-transition", reflect: !0 })
], t.prototype, "noTransition");
o([
  a({ type: String })
], t.prototype, "width");
o([
  a({ type: Boolean, attribute: "disable-compact-mode", reflect: !0 })
], t.prototype, "disableCompactMode");
o([
  a({ type: Boolean, attribute: "show-mobile-toggle", reflect: !0 })
], t.prototype, "showMobileToggle");
o([
  a({ type: String, attribute: "mobile-toggle-position" })
], t.prototype, "mobileTogglePosition");
o([
  a({ type: Boolean, attribute: "show-header-toggle", reflect: !0 })
], t.prototype, "showHeaderToggle");
o([
  a({ attribute: !1 })
], t.prototype, "onToggle");
o([
  a({ attribute: !1 })
], t.prototype, "onCollapse");
export {
  t as AgSidebar
};
