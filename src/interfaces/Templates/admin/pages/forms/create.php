...
<div class="max-w-4xl mx-auto">
    ...
    <form action="/admin/forms/create" method="POST" x-data="formBuilder()" class="space-y-6">
        <!-- Form Name -->
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="mt-4">
                ...
                <input type="email" name="emailNotification" placeholder="admin@example.com"
                       class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" />
            </div>

            <div class="mt-4">
                <label class="block text-sm font-medium text-gray-700 mb-2">Success Message</label>
                <input type="text" name="successMessage" value="Thank you for your submission!"
                       class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" />
            </div>
        </div>
