...
<div class="p-6">
    <div class="max-w-2xl">
        ...
        <form method="POST" action="/admin/roles" class="bg-white rounded-lg shadow p-6">
            <div class="mb-4">
                ...
                <p class="mt-1 text-sm text-gray-500">Valid roles: admin, editor, viewer, user, or custom</p>
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea id="description" 
                          ...
                          rows="3"
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="Describe this role..."><?= $this->e($old['description'] ?? '') ?></textarea>
            </div>
