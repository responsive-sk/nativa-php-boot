...
final class PageManager
{
    ...
    public function addBlock(
        ...
        return PageBlock::create($pageId, $type, $title, $content, $data, $sortOrder);
    ...
    public function attachMedia(
        ...
        return PageMedia::create($pageId, $mediaId, $caption, $sortOrder);
    ...
    public function embedForm(
        ...
        return PageForm::create($pageId, $formId, $title, $position, $sortOrder);
