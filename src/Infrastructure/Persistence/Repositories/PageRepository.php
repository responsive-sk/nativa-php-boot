...
final class PageRepository implements PageRepositoryInterface
{
    ...
    public function findAll(int $limit = 50, int $offset = 0): array
    {
        ...
        return array_map(static fn ($row) => Page::fromArray($row), $stmt->fetchAll());
    }
    ...
    public function getBlocks(string $pageId): array
    {
        ...
        return array_map(static fn ($row) => PageBlock::fromArray($row), $stmt->fetchAll());
    }
    ...
    public function getMedia(string $pageId): array
    {
        ...
        return array_map(static fn ($row) => PageMedia::fromArray($row), $stmt->fetchAll());
    }
    ...
    public function getForms(string $pageId): array
    {
        ...
        return array_map(static fn ($row) => PageForm::fromArray($row), $stmt->fetchAll());
    }
}
