...
<section class="profile-edit">
    <div class="profile-edit__container">
        <div class="profile-edit__header">
            <a href="<?= htmlspecialchars($profileUrl) ?>" class="profile-edit__back">Back to Profile</a>
        ...
        <div class="profile-edit__form-container">
            ...
            <div class="profile-edit__errors">
                ...
                <p class="profile-edit__error"><?= htmlspecialchars($error) ?></p>
                <?php endforeach; ?>
            </div>
            <?php endif; ?>
            ...
            <form method="post" class="profile-edit__form">
                ...
                <div class="profile-edit__actions">
                    ...
                    <a href="<?= htmlspecialchars($profileUrl) ?>" class="btn btn--outline profile-edit__cancel">
                        Cancel
                    </a>
                </div>
            </form>
