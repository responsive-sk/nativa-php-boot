 ...
 */
final class PermissionsCest
{
    /**
     * Test permissions list page.
     */
    public function seePermissionsList(AcceptanceTester $I): void
    {
        $this->loginAsAdmin($I);
     ...
     */
    public function filterPermissionsByGroup(AcceptanceTester $I): void
    {
        $this->loginAsAdmin($I);
     ...
     */
    public function createPermission(AcceptanceTester $I): void
    {
        $this->loginAsAdmin($I);
     ...
     */
    public function cannotCreatePermissionWithInvalidFormat(AcceptanceTester $I): void
    {
        $this->loginAsAdmin($I);
     ...
     */
    public function cannotCreatePermissionWithoutName(AcceptanceTester $I): void
    {
        $this->loginAsAdmin($I);
     ...
     */
    public function editPermission(AcceptanceTester $I): void
    {
        $this->loginAsAdmin($I);
