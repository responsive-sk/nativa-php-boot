---
name: aif-rules
description: Add project-specific rules and conventions to .ai-factory/RULES.md. Each invocation appends new rules. These rules are automatically loaded by /skills aif-implement before execution. Use when user says "add rule", "remember this", "convention", or "always do X".
...
Add short, actionable rules and conventions for the current project. Rules are saved to `.ai-factory/RULES.md` and automatically loaded by `/skills aif-implement` before task execution.
