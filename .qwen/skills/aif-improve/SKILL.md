---
name: aif-improve
description: Refine and enhance an existing implementation plan with a second iteration. Re-analyzes the codebase, checks for gaps, missing tasks, wrong dependencies, and improves the plan quality. Use after /skills aif-plan to polish the plan before implementation.
...
- /skills aif-plan full <description>  — for a new feature (creates branch + plan)
