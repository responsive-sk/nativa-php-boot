...
/skills aif-plan <milestone description>  → creates branch + plan
...
**Requires** `.ai-factory/ROADMAP.md` to exist. If it doesn't — tell the user to run `/skills aif-roadmap` first.
